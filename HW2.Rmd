...
This scatter plot shows the relationship between physical attractiveness (beauty score) and course evaluation scores. The correlation of `r cor(profs$beauty, profs$eval)` indicates a weak, positive relationship between a professor's attractiveness and their evaluation score.
