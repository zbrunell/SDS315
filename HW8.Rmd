...
```
I estimated the price elasticity of demand for milk to be approximately -1.62. Using bootstrapping, I calculated a 95% confidence interval ranging from -1.78 to -1.46. To obtain this estimate, we log-transformed both sales and price and then fit a linear regression model. Bootstrapping was used assess variability between samples. An elasticity of -1.62 means that, on average, a 1% increase in milk prices would lead to a 1.62% decrease in quantity demanded.
